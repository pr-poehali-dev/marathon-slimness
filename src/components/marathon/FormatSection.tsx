...
const formatItems: FormatItem[] = [
  {
    ...
    description: 'Закрытая группа ВКонтакте для общения, поддержки и обмена опытом с участниками.'
  },
  {
    icon: 'FolderOpen',
    title: 'Личный кабинет',
    description: 'Доступ к материалам, расписанию тренировок, рецептам и полезным статьям.'
  },
  {
    icon: 'CheckSquare',
    title: 'Ежедневные задания',
    description: 'Понятные задачи и отчеты для поддержания мотивации и контроля прогресса.'
  },
  {
    icon: 'Video',
    title: 'Прямые эфиры',
    description: 'Онлайн-встречи с экспертами: ответы на вопросы и мотивационные беседы.'
  }
];
